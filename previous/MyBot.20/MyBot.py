...
def findResourcesForRescue(dp, splanets, eplanets, fleets, rescuePlan):
    ...
    for turn, nships in rescuePlan:
        ...
        for sp in splanetsnodp:
            ...
            nships_left -= dispatch + min(growth, 0) - max(growth, 0)
...
def reinforceOwn(pw):
    ...
    for sp in rearPlanets:
        ...
        dispatch = safeDispatchLimit(sp, sp.ClosestFriendly(), sp.ClosestEnemy(), mplanetsnodp, eplanetsnodp, fleets) 
...
def performPlannedOffence(pw, dplanets, eplanets, mplanets, mfleets, fleets):
    ...
    for dp,dprating in dplanets_ratings:
        ...
        #" dpgds", -dpgds, "dpds", dpds, '@', closestFriendDistanceToDP, 'vs', closestEnemyDistanceToDP)
        ...
        for sp, limit, dpdp, proxy in dispatchplan:
            ...
            #debug("A:", sp.ID(), ">", dp.ID(), "<>", distance, "limit:", limit, "need:", need, 'minneed:', dpdp+1)
...
def planAttackVectors(dispatchPlans, sourcesUsedShips, sourcesWaiting, attackPlans, eplanets):
    ...
    for dp, sp, attacklimit, dispatch, proxy, dprating in dispatchPlans:
        ...
        #debug("     ", sp.ID(), ">", dp.ID(), "Checking dispatch plan. Available:", available, "Dispatch:", dispatch, "limit:", attacklimit)
        ...
        needmore += enemyGrowthTotal * (needmore / sp.GrowthRate())
